...
class ProcessFrequencyValidator:
    ...
    def _compute_frequency_pages(self, bmr_pages: Dict[str, Any]) -> Tuple[Dict[str, bool], Dict[str, List[Dict[str, Any]]]]:
        """
        Returns:
        ...
        for k in keys:
            ...
            if state.has_frequency and self._looks_like_frequency_log(page):
                is_freq_page[k] = True
    ...
    def _validate_page_frequency(
        ...
        for i in range(len(records) - 1):
            ...
            role1 = self._detect_role_from_record(rec1)
            role2 = self._detect_role_from_record(rec2)
    ...
    def run_validation(self, bmr_pages: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
        ...
        is_freq_page, freq_info = self._compute_frequency_pages(bmr_pages)
        ...
        for page_no in keys:
            ...
            result = self._validate_page_frequency(page_no, page, freq_list)
...
if __name__ == "__main__":
    ...
    ocr_json_path = "/home/softsensor/Desktop/Amneal/yog_checks/complete_data_61 1.json"
    ...
    # The filled_master_json is inside steps object
    ...
    results = validator.run_validation(bmr_pages)
